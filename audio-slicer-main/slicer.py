...
def main():
    ...
    parser.add_argument('--audio',default="wav/vocals.wav" ,type=str, help='The audio to be sliced')
    parser.add_argument('--out', type=str,default="so-vits-svc-4.0/dataset_raw/speaker0", help='Output directory of the sliced audio clips')
